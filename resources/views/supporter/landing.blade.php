...
<body class="min-h-screen scroll-smooth">
    ...
    <script>
        document.getElementById('landingSearchButton').addEventListener('click', function() {
            ...
            if (keyword) {
                // Redirect ke route explorer-supporter dengan query search
                window.location.href = `/explorer-supporter?search=${encodeURIComponent(keyword)}`;
            } else {
                // Redirect tetap ke explorer jika kosong
                window.location.href = `/explorer-supporter`;
            }
        });
    </script>
</body>
