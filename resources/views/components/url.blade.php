@props(['creator'])
<form method="POST" action="{{ route('creator.updateSocialUrl') }}">
    @csrf
    <div id="urlModal"
        ...
        <div
            ...
            <div class="space-y-3">
                <div>
                    ...
                    <input type="text" name="twitter_url" type="text" value="{{ $creator->twitter_url ?? '' }}"
                ...
                <div>
                    ...
                    <input type="text" name="facebook_url" type="text" value="{{ $creator->facebook_url ?? '' }}"
                        class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-violet-500 focus:border-transparent text-sm"
                ...
                <div>
                    ...
                    <input type="text" name="youtube_url" type="text" value="{{ $creator->youtube_url ?? '' }}"
                        class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-violet-500 focus:border-transparent text-sm"
                ...
                <div>
                    ...
                    <input type="text" name="instagram_url" type="text" value="{{ $creator->instagram_url ?? '' }}"
                        class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-violet-500 focus:border-transparent text-sm"
            ...
            <div class="flex justify-end gap-2 mt-6">
                <button type="button" onclick="closeUrlModal()"
                    class="px-4 py-2 font-semibold text-sm bg-gray-100 text-gray-600 rounded-lg hover:bg-gray-200">Batal</button>
                <button type="submit"
                    class="px-4 py-2 font-semibold text-sm bg-violet-600 text-white rounded-lg hover:bg-violet-700">Simpan</button>
            </div>
        </div>
    </div>
</form>
