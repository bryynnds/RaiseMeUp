...
<div id="donateModal" class="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center z-50 hidden p-4">
    <div class="bg-blue-50 backdrop-blur-xl rounded-3xl w-full max-w-md mx-auto p-6 relative animate-slideUp shadow-2xl border border-white/20 max-h-[90vh] overflow-y-auto">

        <!-- Close Button -->
        <button id="closeDonateModal" class="absolute top-4 right-4 w-8 h-8 bg-blue-50 rounded-full flex items-center justify-center transition-all duration-200 group z-10">
        ...
        <div class="text-center mb-6">
            <div class="relative mb-4">
                <div class="w-16 h-16 bg-gradient-to-br from-violet-500 via-purple-500 to-indigo-600 rounded-2xl flex items-center justify-center mx-auto shadow-lg shadow-purple-500/30">
                ...
                <div class="absolute -top-1 -right-1 w-5 h-5 bg-gradient-to-r from-pink-500 to-rose-500 rounded-full animate-pulse"></div>
            </div>
        ...
        <div class="mb-5 gap-2.5">
            ...
            <div class="grid grid-cols-3 gap-2 mb-3">
                <button class="donation-amount group relative overflow-hidden bg-gradient-to-br from-blue-50 to-indigo-50 hover:from-blue-100 hover:to-indigo-100 border-2 border-blue-200/50 hover:border-indigo-400 rounded-xl p-3 text-center transition-all duration-300 hover:shadow-lg hover:shadow-indigo-500/20 hover:-translate-y-1" data-amount="5000">
                    <div class="absolute inset-0 bg-gradient-to-br from-blue-400/10 to-indigo-400/10 opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
                ...
                <button class="donation-amount group relative overflow-hidden bg-gradient-to-br from-purple-50 to-pink-50 hover:from-purple-100 hover:to-pink-100 border-2 border-purple-200/50 hover:border-pink-400 rounded-xl p-3 text-center transition-all duration-300 hover:shadow-lg hover:shadow-pink-500/20 hover:-translate-y-1" data-amount="25000">
                ...
                <button class="donation-amount group relative overflow-hidden bg-gradient-to-br from-emerald-50 to-teal-50 hover:from-emerald-100 hover:to-teal-100 border-2 border-emerald-200/50 hover:border-teal-400 rounded-xl p-3 text-center transition-all duration-300 hover:shadow-lg hover:shadow-teal-500/20 hover:-translate-y-1" data-amount="50000">
                    <div class="absolute inset-0 bg-gradient-to-br from-emerald-400/10 to-teal-400/10 opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
                    <div class="relative z-10">
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        proceedDonate.addEventListener('click', function() {
            ...
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                this.classList.remove('bg-gradient-to-r', 'from-violet-500', 'via-purple-500', 'to-indigo-600');
                return setTimeout(() => {
                ...
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    ...
                    this.classList.add('bg-gradient-to-r', 'from-violet-500', 'via-purple-500', 'to-indigo-600');
                }, 2000);
            }
