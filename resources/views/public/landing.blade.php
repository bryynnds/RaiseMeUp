...
<body class="min-h-screen scroll-smooth">
    ...
    <div class="max-w-7xl py-4 mx-auto px-8 sm:px-6 lg:px-14">
      <div class="flex justify-between items-center h-20">
        ...
        <div class="flex space-x-6 items-center">
          ...
          <button id="loginBtn" class="w-full text-center text-sm font-bold rounded-md px-2 py-3 bg-white text-gray-700">
            Log In
          </button>
        </div>
      </div>
  ...
  <!-- Hero -->
  <div
    class="w-full h-screen bg-cover bg-center flex flex-col relative overflow-hidden"
    ...
    <div class="h-[42%] w-full flex items-center justify-center relative z-10">
      <div class="flex flex-col items-center justify-center text-center space-y-10">
        ...
        <div class="flex pl-6 items-center justify-end text-right">
          <div class="text-white flex flex-col space-y-2 text-xl lg:text-3xl font-bold leading-relaxed h-[5.5rem] lg:h-[7rem] min-w-[22rem] max-w-[22rem] overflow-hidden whitespace-nowrap">
        ...
        <!-- Searchbar -->
        <div class="backdrop-blur-sm bg-white/20 border border-white/70 w-full max-w-md rounded-full px-4 py-3 flex items-center justify-between">
          <input
            type="text"
          ...
          <span class="bg-blue-500 hover:bg-blue-800 text-sm px-4 py-2 rounded-full text-white font-bold cursor-pointer backdrop-blur-md transition">
            Cari
          </span>
        </div>
      </div>
    ...
    <div class="h-[43vh] flex items-end justify-between relative z-10">
      ...
      <div class="flex items-center justify-center">
        <div class="px-8 py-4 rounded-t-full bg-white flex items-center justify-center">
          <img src="/assets/icon/scroll.png" alt="Scroll Icon" class="w-6 h-6 object-contain animate-bounce-scroll" />
        </div>
      </div>
  ...
  <div class="putih-section w-full h-screen bg-gradient-to-b from-white to-gray-100 flex items-center justify-center text-gray-800 text-3xl font-bold">
    Section 2
  </div>
  ...
  <!-- Footer -->
  <footer class="bg-[#23517F] text-white px-8 lg:px-20 pt-14 pb-6">
    <div class="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-5 gap-8">
      <!-- Logo -->
      <div class="md:col-span-1 flex flex-col gap-4">
        <h2 class="text-2xl font-bold font-protest">RaiseMeUp.id</h2>
        <div class="text-sm text-white/80 leading-relaxed">
          ©2025 RaiseMeUp By PSIE UDB, Inc.<br />
      ...
      <!-- Produk -->
      <div>
        <h3 class="font-semibold text-lg mb-3">Produk</h3>
        <ul class="text-sm space-y-2 text-white/90">
          <li><a href="#" class="hover:underline">Explorer</a></li>
          <li><a href="#" class="hover:underline">Cari Creator</a></li>
          <li><a href="#" class="hover:underline">Menjadi Creator</a></li>
          <li><a href="#" class="hover:underline">Fitur & Harga</a></li>
        </ul>
      </div>
      ...
      <div class="flex flex-col gap-4">
        ...
        <img src="https://upload.wikimedia.org/wikipedia/commons/7/78/Google_Play_Store_badge_EN.svg" alt="Google Play" class="w-40 rounded-md" />

        <div class="flex gap-4 mt-4">
          <a href="#"><img src="https://img.icons8.com/ios-filled/50/000000/youtube-play.png" class="w-9 h-9 p-2 bg-white rounded-full" /></a>
          <a href="#"><img src="https://img.icons8.com/ios-filled/50/000000/twitter.png" class="w-9 h-9 p-2 bg-white rounded-full" /></a>
          <a href="#"><img src="https://img.icons8.com/ios-filled/50/000000/facebook-new.png" class="w-9 h-9 p-2 bg-white rounded-full" /></a>
        </div>
      </div>
    </div>

    <!-- Bottom bar -->
    <div class="bg-[#143251] mt-12 text-white text-xs py-4 px-8 lg:px-20 flex justify-between">
      <span>PSIE.UDB</span>
      <span>2025</span>
    </div>
  </footer>
